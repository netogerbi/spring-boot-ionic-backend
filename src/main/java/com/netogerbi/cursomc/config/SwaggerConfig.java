package com.netogerbi.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api () {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.netogerbi.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
					"Título da API",
					"Breve explicação geral sobre a API",
					"Versão 1.0",
					"https://algumacoisa",
					new Contact("Neto","minhapagina.com", "meu@email.com"),
					"Permissões",
					"http://site-da-documentação",
